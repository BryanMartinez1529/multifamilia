                ...
                <?php if ($empresa) { ?>
                    <form action="<?php echo site_url("/reuniones_controller/guardarReunion") ?>" method="post" enctype="multipart/form-data" id="frm">
                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" name="lugar_reu" id="lugar_reu" aria-describedby="helpId" placeholder="ingrese el lugar de la reunión" />
                                </div>
                            ...
                            <div class="col-4">
                                <div class="mb-3">
                                    ...
                                    <input value="<?php echo date('Y-m-d'); ?>" type="date" class="form-control" name="fecha_reu" id="fecha_reu" aria-describedby="helpId" placeholder="" />
                                </div>
                            ...
                            <div class="col-4">
                                <div class="mb-3">
                                    ...
                                    <input value="<?php echo date('H:i'); ?>" type="time" class="form-control" name="hora_reu" id="hora_reu" aria-describedby="helpId" placeholder="" />
                                </div>
                        ...
                        <div class="row">
                            <div class="col-3">
                                <div class="mb-3">
                                    ...
                                    <textarea name="asunto_reu" id="asunto_reu" cols="30" rows="10"></textarea>
                            ...
                            <div class="col-3">
                                <div class="mb-3">
                                    ...
                                    <textarea name="punto1" id="punto1" cols="30" rows="10"></textarea>

                                </div>
                            </div>
                            <div class="col-3">
                                <div class="mb-3">
                                    <label for="punto2" class="form-label">punto 3</label>
                                    <textarea name="punto2" id="punto2" cols="30" rows="10"></textarea>

                                </div>
                            </div>
                            <div class="col-3">
                                <div class="mb-3">
                                    <label for="punto3" class="form-label">punto 4</label>
                                    <textarea name="punto3" id="punto3" cols="30" rows="10"></textarea>
                        ...
                        <div class="row">
                            <div class="col-3">
                                <div class="mb-3">
                                    <label for="punto4" class="form-label">punto 1</label>
                                    <textarea name="punto4" id="punto4" cols="30" rows="10"></textarea>
                            ...
                            <div class="col-3">
                                <div class="mb-3">
                                    ...
                                    <textarea name="punto5" id="punto5" cols="30" rows="10"></textarea>
                            ...
                            <div class="col-3">
                                <div class="mb-3">
                                    ...
                                    <textarea name="punto6" id="punto6" cols="30" rows="10"></textarea>
                            ...
                            <div class="col-3">
                                <div class="mb-3">
                                    ...
                                    <textarea name="punto7" id="punto7" cols="30" rows="10"></textarea>
