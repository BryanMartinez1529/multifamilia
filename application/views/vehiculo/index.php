            ...
            <div class="card-header">
                ...
                <div class="card-tools">
                     <button type="button" class="btn btn-dark" title="Collapse"> <!-- data-card-widget="collapse" -->
                        ...
                        </svg><a href="<?php echo site_url("/ExcelController/generateExcelVehiculos") ?>" style="color: white;">Lista Vehiculos excel</a></i>
                    </button>
                    <button  type="button" class="btn btn-dark" title="Collapse"> <!-- data-card-widget="collapse" -->
                        ...
                        </svg><a target="_blank" href="<?php echo site_url("/PdfController/pdfVehiculoGeneral") ?>" style="color: white;">Lista Vehiculos pdf</a></i>
                    </button>
                    <button type="button" class="btn btn-dark" title="Collapse"> <!-- data-card-widget="collapse" -->
