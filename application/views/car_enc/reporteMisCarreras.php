                            ...
                            <div class="card bg-light d-flex flex-fill">
                                <div class="card-header text-muted border-bottom-0">
                                    ...
                                    <center>
                                        ...
                                        numero de telefono: <?php echo $registro->solicitante_telefono ?><br>
                                    ...
                                    <?php }
                                    if ($registro->estadoCarrera == "ACEPTADO") { ?>
                                        <h6 style="color: green;"> <?php echo $registro->estadoCarrera ?></h6>
                                    <?php } else if ($registro->estadoCarrera == "RECHAZADO") { ?>
                                ...
                                <div class="card-footer">
                                    <div class="row">
                                            ...
                                            <div class="col-4">
                                                <a name="" id="" class="btn btn-warning" href="#" role="button">Aceptar</a>
                                            ...
                                            <div class="col-4">
                                                <a name="" id="" class="btn btn-danger" href="#" role="button">Rechazar</a>
                            ...
                            <div class="timeline-item">
                                ...
                                <div class="timeline-body">
                                    Buenas estiamd@ <?php  $usuario = $this->session->userdata("conectado")->nombres;
                                        echo $usuario;
                                    ?>  Por el momento usted no cuneta con nigun pedido de servicio de carrara.
                                </div>
