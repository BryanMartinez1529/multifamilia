        ...
        <div class="card card-warning">
            <div class="card-header">
                ...
                <button type="button" class="btn btn-dark" title="Collapse"> <!-- data-card-widget="collapse" -->
                        ...
                        </svg><a href="<?php echo site_url("/ExcelController/generateExcel") ?>" style="color: white;">Lista General excel</a></i>
                    </button>
                    <button  type="button" class="btn btn-dark" title="Collapse"> <!-- data-card-widget="collapse" -->
                        ...
                        </svg><a target="_blank" href="<?php echo site_url("/PdfController/pdfSociosGeneral") ?>" style="color: white;">Lista Socios pdf</a></i>
                    </button>

                    <button type="button" class="btn btn-dark" title="Collapse"> <!-- data-card-widget="collapse" -->
                        <i class="fas fa-plus"> <a href="<?php echo site_url("/usuarios_controller/nuevoSocio") ?>" style="color: white;"> Nuevo Socio</a></i>
                    </button>
                </div>
            </div>
