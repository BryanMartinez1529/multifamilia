        ...
        <div class="card card-warning">
            <div class="card-header">
                ...
                <button type="button" class="btn btn-dark" title="Collapse"> <!-- data-card-widget="collapse" -->
                        ...
                        </svg><a href="<?php echo site_url("/ExcelController/generateExcelChofer") ?>" style="color: white;">Lista Choferes excel</a></i>
                    </button>
                    <button  type="button" class="btn btn-dark" title="Collapse"> <!-- data-card-widget="collapse" -->
                        ...
                        </svg><a target="_blank" href="<?php echo site_url("/PdfController/pdfChoferGeneral") ?>" style="color: white;">Lista Choferes pdf</a></i>
                    </button>
                    <button type="button" class="btn btn-dark" title="Collapse"> <!-- data-card-widget="collapse" -->
